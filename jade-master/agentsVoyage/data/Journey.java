...
public class Journey implements Cloneable, Serializable, Comparable<Journey> {
    ...
    private static String PLACE = ", sit left = ";
	...
	public String toString() {
	    return new StringBuilder(Journey.TRAJECTFROM).append(start).append(Journey.TO).
                ...
                append(Journey.COST).append(cost).append(Journey.PLACE).append(nbPlace).append(Journey.PROPOSEDBY).append(proposedBy).toString();
	}
